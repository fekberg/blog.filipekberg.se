...
Since I didn't really know anything about how to write LaTeX markup, I searched for a free tools that could help me; I found a program called <a href="http://www.texniccenter.org/"><strong>TeXnicCenter</strong></a>. However, just downloading and installing TeXnicCenter is not enough, you also need to install the "compiler". According to TeXnicCenter, I could get something called Tex Live for this. Tex Live has binaries for both Windows, Unix and GNU/Linux.
