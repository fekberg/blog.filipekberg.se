...
I will not go into detail on the language features of C# vNext as there will be an article published by me in the DNC Magazine on this, keep an eye out for that if you are keen on the new language features of C# (6) vNext. Instead we will take a look at how we can use what is available to us today from an analysis perspective and use that to analyse some C# code.<!--excerpt-->
